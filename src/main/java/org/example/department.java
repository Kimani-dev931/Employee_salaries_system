...
public class department {
    ...
    public static void Insertdepartment(String tableName, Map<String, String> fieldValues, Connection connection) {
        try {
    ...
    public static void updatedepartment(String tableName, String idColumn, int idValue, Map<String, String> fieldValues, Connection connection) {
        try {
    ...
    public static JSONArray selectdepartment(Connection connection, String tableName, List<String> columns,
