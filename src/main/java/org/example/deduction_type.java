...
public class deduction_type {
    ...
    public static void Insertdeduction_type(String tableName, Map<String, String> fieldValues, Connection connection) {
        try {
    ...
    public static void updatededuction_type(String tableName, String idColumn, int idValue, Map<String, String> fieldValues, Connection connection) {
        try {
    ...
    public static JSONArray selectdeduction_type(Connection connection, String tableName, List<String> columns,
