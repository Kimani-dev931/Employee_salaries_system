...
public class earning_type {
    public static void Insertearning_type(String tableName, Map<String, String> fieldValues, Connection connection) {
        try {
    ...
    public static void update_earning_type(String tableName, String idColumn, int idValue, Map<String, String> fieldValues, Connection connection) {
        try {
    ...
    public static JSONArray selectearning_type(Connection connection, String tableName, List<String> columns,
