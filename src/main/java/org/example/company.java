...
public class company {
    public static void Insertcompany(String tableName, Map<String, String> fieldValues, Connection connection) {
        try {
    ...
    public static void updatecompany(String tableName, String idColumn, int idValue, Map<String, String> fieldValues, Connection connection) {
        try {
    ...
    public static JSONArray selectcompany(Connection connection, String tableName, List<String> columns,
