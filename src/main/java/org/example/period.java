...
public class period {
    ...
    public static void Insertperiod(String tableName, Map<String, String> fieldValues, Connection connection) {
        try {
    ...
    public static void updateperiod(String tableName, String idColumn, Object idValue, Map<String, String> fieldValues, Connection connection) {
        try {
    ...
    public static JSONArray selectperiod(Connection connection, String tableName, List<String> columns,
